...
folder are mapped to the application's root namespace, 'SuperQuicks'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SuperQuicks"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SuperQuicks' in the same way
as `"SuperQuicks/sass/src"`.
